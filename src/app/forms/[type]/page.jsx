...
const BRAND_KEY = 'mind_studio';
const BRAND = { name: 'The Mind Studio', bg: '#0E0E12', accent: '#B39DDB', text: '#EDE7F6', font: "'DM Sans', serif" };
    ...
    <div style={{minHeight:'100vh',background:BRAND.bg,color:BRAND.text,fontFamily:BRAND.font}}>
      ...
      <div style={{position:'relative',zIndex:1,padding:'60px 20px 80px'}}>
        <div style={{maxWidth:560,margin:'0 auto'}}>
          ...
          <p style={{textAlign:'center',marginTop:40,fontSize:11,opacity:0.25,fontFamily:"'DM Sans',sans-serif",letterSpacing:1}}>© {new Date().getFullYear()} The Mind Studio — Powered by The Kollective</p>
        </div>
      </div>
    </div>
  );
